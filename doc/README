PrimeChain 0.1.2
Copyright (c) 2014 PrimeChain developers
...
About PrimeChain
---------------
PrimeChain is a PrimeChain network-compatible, community-developed wallet client.

The project has been designed to provide people with a
stable, secure, and feature-rich alternative to the PrimeChain reference
wallet (http://github.com/PrimeChain/PrimeChain). 

To help faciliate broad community cooperation, a number of trusted 
PrimeChain/Peershares community leaders have write permissions to the project's 
...
Resources
---------
PrimeChain source code: https://github.com/PrimeChain/PrimeChain

For the most current instructions covering how to compile PrimeChain from 
source on a variety of operating systems, please visit:
https://github.com/PrimeChain/PrimeChain/tree/master/doc

Open software issues can be viewed, and new issues can be reported at:
https://github.com/PrimeChain/PrimeChain/issues?state=open

PrimeChain discussion forums (hosted by PrimeChainTalk.org): 
http://www.PrimeChaintalk.org/index.php?board=64.0



Acknowledgements
----------------
PrimeChain owes it's existance to the time and effort put forth by
the developers and supporters of the following projects:


	PrimeChain (PrimeChain) 0.4.0 BETA
	Copyright (c) 2011-2014 Bitcoin Developers

	Distributed under the MIT/X11 software license
	(http://www.opensource.org/licenses/mit-license.php)

	PrimeChain is a free open source project with the goal of providing a 
	...
	http://github.com/PrimeChain/PrimeChain
