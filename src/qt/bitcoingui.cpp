 ...
 * The PrimeChain Developers 2011-2013
 */
...
{
    resize(850, 550);
    setWindowTitle(tr("PrimeChain Wallet"));
#ifndef Q_WS_MAC
    setWindowIcon(QIcon(":icons/PrimeChain_icon"));
#else
	...
	analyticsPage = new Analytics(this);
	...
	centralWidget->addWidget(analyticsPage);
...
void BitcoinGUI::createActions()
{
    ...
    mintingAction = new QAction(QIcon(":/icons/stake"), tr("&Stake Predictor"), this);
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a PrimeChain address"));
    sendCoinsAction->setCheckable(true);
    sendCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_2));
    tabGroup->addAction(sendCoinsAction);
	
	analyticsAction = new QAction(QIcon(":/icons/web"), tr("&Analytics"), this);
    analyticsAction->setToolTip(tr("View Prime Analytics"));
    analyticsAction->setCheckable(true);
    analyticsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_7));
    tabGroup->addAction(analyticsAction);
	...
	connect(analyticsAction, SIGNAL(triggered()), this, SLOT(gotoAnalyticsPage()));
    connect(analyticsAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));

    quitAction = new QAction(QIcon(":/icons/quit"), tr("E&xit"), this);
    quitAction->setToolTip(tr("Quit application"));
    quitAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_Q));
    quitAction->setMenuRole(QAction::QuitRole);
    aboutAction = new QAction(QIcon(":/icons/PrimeChain_tooltip"), tr("&About PrimeChain"), this);
    aboutAction->setToolTip(tr("Show information about PrimeChain"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for PrimeChain"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/PrimeChain_tooltip"), tr("Show/Hide &PrimeChain"), this);
    toggleHideAction->setToolTip(tr("Show or hide the PrimeChain window"));
...
void BitcoinGUI::createToolBars()
{
	...
	toolbar->addAction(analyticsAction);
#ifdef FIRST_CLASS_MESSAGING
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        if(clientModel->isTestNet())
        {
            ...
            setWindowIcon(QIcon(":icons/PrimeChain_icon"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/PrimeChain_icon"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(title_testnet);
                trayIcon->setIcon(QIcon(":/icons/PrimeChain_tooltip"));
            }
        }
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("PrimeChain client"));
    trayIcon->setIcon(QIcon(":/icons/PrimeChain_tooltip"));
	...
	trayIconMenu->addAction(analyticsAction);
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PrimeChain network", "", count));
}
...
void BitcoinGUI::gotoAnalyticsPage()
{
	analyticsAction->setChecked(true);
	centralWidget->setCurrentWidget(analyticsPage);
